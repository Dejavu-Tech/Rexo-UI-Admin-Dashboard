 ...
 * 模板 DEMO 的六个配置文件位于 demo-configs/demo-*.js，可根据主题需要更名为 themeConfig.js 并覆盖本文件
 */
const themeConfig = {
  // 布局配置
  templateName: 'Rexo-UI' /* 应用名称 */,
  layout: 'horizontal' /* vertical | horizontal （垂直导航 | 水平导航）*/,
  mode: 'light' /* light | dark | semi-dark （外观：浅色 | 深色 | 混合（深色导航栏 + 浅色内容））！混合外观只适用于垂直导航布局 */,
  direction: 'ltr' /* ltr | rtl （文本方向：从左到右 | 从右到左）*/,
  skin: 'default' /* default | bordered （皮肤：立体阴影 (默认) | 平面线框）*/,
