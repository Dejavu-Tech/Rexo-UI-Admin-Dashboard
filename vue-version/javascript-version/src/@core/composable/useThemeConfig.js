...
export const useThemeConfig = () => {
  ...
  // 导出 @layouts
  const { isNavbarBlurEnabled, isVerticalNavCollapsed, appContentWidth, appContentLayoutNav, horizontalNavType, isLessThanOverlayNavBreakpoint, isAppRtl, switchToVerticalNavOnLtOverlayNavBreakpoint } = useLayouts()
