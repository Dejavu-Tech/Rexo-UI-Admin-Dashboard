export default {
  ...
  VRating: {
    // 设置 v-rating 默认颜色为项目主色
    color: 'warning',
  },
  VProgressCircular: {
    // 设置 v-progress-circular 默认颜色为项目主色
    color: 'primary',
  },
  VProgressLinear: {
    height: 12,
